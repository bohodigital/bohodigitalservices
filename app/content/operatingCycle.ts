export const operatingCycle = [
  {
    ...
    number: "01",
    title: "Discover",
    body: "Understand the business, customer, market, website, constraints, and valuable next action before prescribing work.",
    href: "/services/research-audits-analytics/",
    linkLabel: "Explore discovery and research",
  },
  {
    id: "prioritize",
    number: "02",
  ...
  },
  {
    ...
    number: "03",
    title: "Build",
    body: "Design, repair, migrate, write, configure, or optimize the smallest useful system with a clear scope.",
    href: "/services/",
    linkLabel: "Explore the work Boho builds",
  },
  {
    id: "measure",
    number: "04",
