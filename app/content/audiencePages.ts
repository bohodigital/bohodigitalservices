...
export const audiencePages: PageConfig[] = [
  ...
  },
  {
    ...
    draftLabel: "Reviewed plain-language reference",
    sections: [
      {
  ...
  },
  {
    slug: "/tools/",
    pageKind: "tools",
    title: "Governed Capability Index | Boho Digital Services",
    metaDescription:
      "Boho capability classifications, evidence gates, and architecture notes without unverified public tool claims.",
    eyebrow: "Tools",
    headline: "Governed capabilities, not a software-logo catalog.",
    intro: [
      "Public capability profiles require accepted current Bohopi evidence. No profile is promoted as verified in this review because no current candidate is proof-eligible.",
    ],
    theme: "research",
    primaryCta: { label: "Read the Evidence Gate", href: "#evidence-gate" },
    secondaryCta: { label: "Discuss Custom Engineering", href: "/services/custom-tools-automation/" },
    noIndex: true,
